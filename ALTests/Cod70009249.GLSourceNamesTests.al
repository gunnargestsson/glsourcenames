codeunit 70009249 "O4N GL Test Codeunits"
{
    ...
    var
        TempAggregatedAssistedSetup : Record "Aggregated Assisted Setup" temporary;
    begin
        ...
        TempAggregatedAssistedSetup.OnRegisterAssistedSetup(TempAggregatedAssistedSetup);
        // [THEN] Assisted setup for G/L Source Names should be found
        TempAggregatedAssistedSetup.setrange("Page ID",page::"O4N GL SN Setup Wizard");
        Assert.RecordIsNotEmpty(TempAggregatedAssistedSetup);
    end;
    ...
    local procedure TestSourceNameInLookupTable(SourceType: Option; SourceNo: code[20];SourceName: Text[50])
    var
        GLSourceName: record "O4N GL SN";
    begin
